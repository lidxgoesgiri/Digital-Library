<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-purple-600">{{ __('Book List') }}</h2>
                    ...
                    <a href="{{ route('user.books.show', $book) }}" 
                       ...
                       style="animation-delay: {{ ($index % 10) * 50 }}ms">
                        <div class="aspect-[3/4] overflow-hidden relative">
                            ...
                            @else
                                <div class="w-full h-full bg-purple-600/30 flex items-center justify-center">
                        ...
                        <div class="p-4">
                            <h4 class="font-semibold text-white truncate group-hover:text-purple-600 transition-all">{{ $book->title }}</h4>
